...
class JFormFieldBoardTags extends JFormFieldList
{
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		{
			$this->name     = '';
			$this->value    = Route::_(BoardHelperRoute::getListRoute($this->value));
	...
	protected function getOptions()
	{
		...
		$root->value = Route::_(BoardHelperRoute::getListRoute(1));
		...
		if (!empty($tags) && is_array($tags))
		{
			...
			foreach ($objects as $i => $tag)
			{
				...
				$option->value = Route::_(BoardHelperRoute::getListRoute($id));
