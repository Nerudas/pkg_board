...
class BoardViewCategories extends HtmlView
{
	...
	{
		BoardHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		$canDo = BoardHelper::getActions('com_board', 'categories');

		JToolBarHelper::title(Text::_('COM_BOARD') . ': ' . Text::_('COM_BOARD_CATEGORIES'), 'bookmark');

		if ($canDo->get('core.create') || count($user->getAuthorisedCategories('com_board', 'core.create')) > 0)
		{
