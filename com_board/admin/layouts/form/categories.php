...
HTMLHelper::_('stylesheet', 'media/com_board/css/form-categories.min.css', array('version' => 'auto'));
HTMLHelper::_('script', 'media/com_board/js/form-categories.min.js', array('version' => 'auto'));
...
?>
<div data-input-boardcategories="">
	<div class="currents">
		<ul class="actives">
	...
	<div id="categorySelect" class="">
		<div class="tabbable tabs-left">
			...
			<?php echo HTMLHelper::_('bootstrap.addTab', 'categories', 'extd', Text::_('COM_BOARD_ITEM_CATEGORIES_EXTENDED')); ?>
